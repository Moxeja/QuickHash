...
std::string crypto::calculate_md5(const std::string* filepath)
{
...
std::string crypto::calculate_sha1(const std::string* filepath)
{
...
std::string crypto::calculate_sha256(const std::string* filepath)
{
